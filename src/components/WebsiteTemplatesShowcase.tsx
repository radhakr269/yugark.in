            ...
            return (
              ...
              >
                ...
                <div className="relative bg-[#121212] overflow-hidden">
                  {/* Browser Top Dot Bar */}
                  <div className="px-3 py-1.5 bg-[#171717] border-b border-neutral-800 flex items-center justify-between">
                    <div className="flex items-center gap-1">
                      <div className="w-2 h-2 rounded-full bg-red-500/70" />
                      <div className="w-2 h-2 rounded-full bg-yellow-500/70" />
                      <div className="w-2 h-2 rounded-full bg-green-500/70" />
                    </div>
                    <span className="text-[9px] font-mono text-neutral-400">demo.yugark.in/{template.id}</span>
                    <span className="w-4" />
                  </div>
                  ...
                  <div className="relative h-48 sm:h-52 overflow-hidden">
                    ...
                    {/* "Demo Template" Badge */}
                    <div className="absolute top-3 left-3 px-2 py-0.5 rounded bg-black/80 backdrop-blur-md border border-[#D4B06A]/30 text-[9px] uppercase font-bold tracking-wider text-[#D4B06A]">
                      {template.liveBadge || 'Demo Template'}
                    </div>

                    {/* Turnaround Pill */}
                    <div className="absolute top-3 right-3 px-2 py-0.5 rounded bg-[#0A0A0A]/90 text-[9px] font-medium text-neutral-300 border border-neutral-700">
                      ⚡ 7-Day Launch
                    </div>
                ...
                <div className="p-5 sm:p-6 flex-1 flex flex-col justify-between space-y-4">
                  <div className="space-y-2.5">
                    <div className="flex items-center gap-2 text-[#D4B06A]">
                      ...
                      <span className="text-[11px] uppercase font-bold tracking-wider text-[#D4B06A]">
                        {template.industry}
                      </span>
                    </div>
                  ...
                  <div className="pt-2 border-t border-neutral-800/80 space-y-1.5 text-xs text-neutral-300">
                    {template.websiteIncludes.slice(0, 2).map((inc, i) => (
                      <div key={i} className="flex items-start gap-1.5 truncate">
                        ...
                        <span className="text-[11px] truncate text-neutral-300">{inc}</span>
                      </div>
                    ))}
                  </div>
                  ...
                  <div className="pt-3 border-t border-neutral-800/80 flex items-center justify-between gap-2">
                    <div>
                      ...
                      <span className="text-base font-serif font-bold text-[#F0D28F]">
                        ₹12,999
                      </span>
                    </div>
