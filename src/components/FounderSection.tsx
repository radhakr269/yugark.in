    ...
    <section className="relative py-20 sm:py-28 bg-[#050505] overflow-hidden border-t border-[#D4B06A]/15">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <motion.div 
          ...
          className="p-8 sm:p-12 md:p-14 rounded-3xl bg-[#0A0A0A] border border-[#D4B06A]/30 shadow-2xl relative overflow-hidden"
        >
          {/* Top Gold Accent Bar */}
          ...
          <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
            <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-[#0D0D0D] border border-[#D4B06A]/30 text-xs text-[#D4B06A] font-medium tracking-wider uppercase">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              {[
                ...
                <div key={idx} className="flex items-center space-x-2.5 bg-[#0D0D0D] p-3 rounded-xl border border-neutral-800">
            ...
            <div className="pt-6 border-t border-neutral-800/80 flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-3">
                <a
                  ...
                  className="inline-flex items-center space-x-2 px-5 py-2.5 rounded-full bg-[#25D366] text-black text-xs font-bold uppercase tracking-wider hover:brightness-110 transition-all shadow-lg"
                >
                ...
                <Link
                  to="/about"
                  className="inline-flex items-center space-x-1 px-4 py-2.5 rounded-full border border-[#D4B06A]/40 text-[#D4B06A] hover:bg-[#D4B06A] hover:text-black text-xs font-semibold transition-all"
                >
